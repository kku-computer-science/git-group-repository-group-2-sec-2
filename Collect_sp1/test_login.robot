...
User Login With Empty Username And Password
    ...
    Wait Until Element Is Visible  id=username  timeout=1s
    Click Button  xpath=//button[text()='Log In']
    Wait Until Page Contains  Please enter username and password  timeout=1s
...
User Login With Correct Username Only
    ...
    Click Button  xpath=//button[text()='Log In']
    Wait Until Page Contains  Please enter password  timeout=1s
    Capture Page Screenshot
    Close Browser
...
User Login With Correct Password Only
    ...
    Click Button  xpath=//button[text()='Log In']
    Wait Until Page Contains  Please enter username  timeout=1s
    Capture Page Screenshot
    Close Browser
...
User Login With Incorrect Credentials
    ...
    Input Text  id=password  ${INVALID_PASSWORD}
    Click Button  xpath=//button[text()='Log In']
    Wait Until Page Contains  Invalid username or password  timeout=1s
    Capture Page Screenshot
    Close Browser
...
User Can Successfully Login
    ...
    Input Text  id=password  ${PASSWORD}
    Click Button  xpath=//button[text()='Log In']
    Wait Until Page Contains  Dashboard  timeout=1s
    Capture Page Screenshot
    Close Browser
