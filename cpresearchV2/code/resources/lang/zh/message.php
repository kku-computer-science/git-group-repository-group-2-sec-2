...
'Cancel' => '取消',
    ...
    'cellular_automata' => '细胞自动机',
    'natural_language_speech_processing' => '自然语言与语音处理',
    'machine_learning_intelligent_systems' => '机器学习与智能系统',
    'database_information_integration_systems' => '数据库与信息集成系统',
    'data_science_ai' => '数据科学与人工智能',
    'computational_intelligence' => '计算智能',
    'nature_optimization_algorithm' => '自然启发优化算法',
    'artificial_neural_network' => '人工神经网络',
    'soft_computing' => '软计算',
    'object_oriented_programming' => '面向对象的编程语言',
    'software_engineering' => '软件工程',
    'ubiquitous_blended_learning' => '无处不在的学习, 混合学习',
    'bioinformatics' => '生物信息学',
    'user_experience_design' => '用户体验设计',
    'mobile_computing' => '移动计算',
    'cloud_computing' => '云计算',
    'iot_smart_technology' => '物联网与智能技术',
    'wireless_sensor_networks' => '无线传感器网络',
    'wireless_cellular_networks' => '无线和蜂窝网络',
    'computer_network_security' => '计算机与网络安全',
    'network_protocol_optimization' => '网络、协议、优化与智能系统',
    'routing_protocols_internetworking' => '路由协议与互联网络',
    'mobile_ad_hoc_networks' => '移动自组网络',
    'evolutionary_algorithms' => '进化算法',
    'software_process' => '软件过程',
    'code_smells_software_quality' => '代码异味与软件质量',
    'secure_software_engineering' => '安全软件工程',
    'mobile_agent_multi_agent_systems' => '移动代理与多代理系统',
    'data_mining' => '数据挖掘',
    'image_processing' => '图像处理',
    'robotics' => '机器人学',
    'text_mining' => '文本挖掘',
    'satellite_image_classification' => '卫星图像分类',
    'human_computer_interaction' => '人机交互',
    'ai_healthcare' => '医疗中的人工智能',
    ...
    'expertise_translation' => [
        ...
        'Natural Language and Speech Processing' => '自然语言与语音处理',
        'Machine Learning and Intelligent Systems' => '机器学习与智能系统',
        'Database and Information Integration Systems' => '数据库与信息集成系统',
        'Data science and Artificial Intelligence' => '数据科学与人工智能',
        'Computational Intelligence' => '计算智能',
        'Nature-Inspired Optimization Algorithm' => '自然启发优化算法',
        'Artificial Neural Network' => '人工神经网络',
        'Soft computing' => '软计算',
        'Object-Oriented Programming Languages' => '面向对象的编程语言',
        'Software Engineering' => '软件工程',
        'Ubiquitous Learning, Blended Learning' => '无处不在的学习, 混合学习',
        'Bioinformatics' => '生物信息学',
        'User Experience Design' => '用户体验设计',
        'Mobile Computing' => '移动计算',
        'Cloud computing' => '云计算',
        'Internet of Things and Smart Technology' => '物联网与智能技术',
        'Wireless Sensor Networks' => '无线传感器网络',
        'Wireless and Cellular Networks' => '无线和蜂窝网络',
        'Computer and Network Security' => '计算机与网络安全',
        'Network, Protocol, Optimization, and Intelligent Systems' => '网络、协议、优化与智能系统',
        'Routing Protocols and Internetworking' => '路由协议与互联网络',
        'Mobile Ad Hoc Networks' => '移动自组网络',
        'Internet of Things and Smart Technologies' => '物联网与智能技术',
        'Evolutionary Algorithms' => '进化算法',
        'Software Process' => '软件过程',
        'Code Smells and Software Quality' => '代码异味与软件质量',
        'Secure Software Engineering' => '安全软件工程',
        'Computer Network Security' => '计算机网络安全',
        'Mobile Agent and Multi-Agent Systems' => '移动代理与多代理系统',
        'Information Extraction and Integration' => '信息提取与集成',
        'Internet and Web Information Systems' => '互联网与网络信息系统',
        'Object Oriented Programming' => '面向对象编程',
        'Temporal Causality Analysis' => '时间因果分析',
        ...
        'Deep Learning' => '深度学习',
        'Data science' => '数据科学',
        'Semantic Web and Ontology Engineering' => '语义网与本体工程',
        'Ontology-based Data Integration' => '基于本体的数据集成',
        'Semantic Sentiment Analysis' => '语义情感分析',
        'Internet of Things' => '物联网',
        'Wireless Sensor Networks and Ad Hoc Networks' => '无线传感器网络与自组网',
        'Computer Networks and Internet' => '计算机网络与互联网',
        'Parallel/Distributed Systems and Cloud Computing' => '并行/分布式系统与云计算',
        'Computer, System, Management, Modelling, and Security' => '计算机、系统、管理、建模与安全',
        'Intelligent Systems' => '智能系统',
        'Smart X: Smart Farm, Home, Health-care, Car, Building, Device, etc.' => '智能X：智能农场、家居、医疗、汽车、建筑、设备等。',
        'Semantic Web' => '语义网',
        'Information Integration' => '信息集成',
        'Logistics and Supply Chain' => '物流与供应链',
        'Data Mining' => '数据挖掘',
        'Data mining' => '数据挖掘',
        'Ensemble Learning Model' => '集成学习模型',
        'Applied Software Testing in Optimization Algorithm' => '优化算法中的应用软件测试',
        'Metaheuristic algorithms' => '元启发式算法',
        'Business Intelligence and Analytics' => '商业智能与分析',
        'Enterprise Systems, ERP systems' => '企业系统、ERP系统',
        'IT Strategy, IT Strategic Planning, IT Management' => 'IT战略、IT战略规划、IT管理',
        'Enterprise Process Modeling' => '企业流程建模',
        'Image Processing' => '图像处理',
        'Search Protocol' => '搜索协议',
        'Ontology' => '本体论',
        'Database' => '数据库',
        'Wireless Mobile Communications (OFDM Systems)' => '无线移动通信（OFDM系统）',
        'Digital Signal Processing (Image, Speech, Sound, Ultrasound)' => '数字信号处理（图像、语音、声音、超声波）',
        '3D Stereoscopic' => '3D立体技术',
        'Embedded and Intelligent Systems (iHOME, iFARM)' => '嵌入式与智能系统（iHOME, iFARM）',
        'Intrusion Detection and Prevention Systems' => '入侵检测与防御系统',
        'Speech Analysis and Synthesis' => '语音分析与合成',
        'Robotics' => '机器人学',
        'Wireless Network' => '无线网络',
        'Network Simulation' => '网络仿真',
        'System Engineer' => '系统工程',
        'Text Mining' => '文本挖掘',
        'Opinion Mining' => '意见挖掘',
        'Learning Engineering' => '学习工程',
        'Formal Method' => '形式化方法',
        'AI for Formal Verification' => '形式验证中的人工智能',
        'Database Programming' => '数据库编程',
        'Hydrologic modeling with GIS' => '基于GIS的水文建模',
        'Internet GIS , Health GIS' => '互联网GIS、健康GIS',
        'Remote Sensing and GIS in Geology' => '地质学中的遥感与GIS',
        'Hydrology' => '水文学',
        'Landuse/Landcover and Natural Hazard' => '土地利用/土地覆盖与自然灾害',
        'Urban Remote Sensing' => '城市遥感',
        'Application in Remote Sensing' => '遥感应用',
        'Remote Sensing for Vegetation study' => '植被遥感研究',
        'Remote Sensing' => '遥感',
        ...
        'Artificial Intelligence in Healthcare' => '医疗中的人工智能',
        'Persuasive Technology' => '说服技术',
        'Social Technologies' => '社交技术',
        'E-Commerce' => '电子商务',
        'Applied Software Testing in Optimization Algorithms' => '优化算法中的应用软件测试',
        'Data Mining and Machine Learning for Health Informatics' => '医疗信息学中的数据挖掘与机器学习',
