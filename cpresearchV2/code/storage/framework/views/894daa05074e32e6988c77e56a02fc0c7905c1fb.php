...
<div class="container">
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                <h4 class="card-title"><?php echo e(trans('message.user_info')); ?></h4>
                <p class="card-description"><?php echo e(trans('message.user_details')); ?></p>
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.name_th')); ?></b></h6>
                    <h6 class="col-md-9"><?php echo e($user->title_name_th); ?> <?php echo e($user->fname_th); ?> <?php echo e($user->lname_th); ?></h6>
                </div>
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.name_en')); ?></b></h6>
                    <h6 class="col-md-9"><?php echo e($user->title_name_en); ?> <?php echo e($user->fname_en); ?> <?php echo e($user->lname_en); ?></h6>
                </div>
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.email')); ?> :</b></h6>
...
<?php $__currentLoopData = $user->getRoleNames(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="row mt-2">
        <h6 class="col-md-3"><b><?php echo e(trans('message.role')); ?> </b></h6>
        <h6 class="col-md-9">
            <label class="badge badge-dark">
                <?php if($locale == 'th' || $locale == 'zh' || $locale == 'en'): ?>
                    <?php echo e(isset($roleMap[$val]) ? $roleMap[$val] : $val); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($val == "teacher"): ?>
                <div class="row mt-2">
                    <h6 class="col-md-3"><b> <?php echo e(trans('message.academic_ranks')); ?> </b></h6>
...
<h6 class="col-md-9">
    <?php if(app()->getLocale() == 'zh'): ?>
        ...
        <?php echo e($academic_ranks_map[$user->academic_ranks_en] ?? $user->academic_ranks_en); ?>

    <?php else: ?>
        
        <?php echo e($user->{'academic_ranks_'.app()->getLocale()}); ?>
    ...
    <?php endif; ?>
                 ...
                 <!-- ============================================================================ -->
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.department')); ?> </b></h6>
                    <?php
...
<h6 class="col-md-9">
    <?php if(app()->getLocale() == 'zh'): ?>
        ...
        <?php echo e($department_map[$user->program->department->department_name_en] ?? $user->program->department->department_name_en); ?>

    <?php else: ?>
        
        <?php echo e($user->program->department->{'department_name_'.app()->getLocale()}); ?>
    ...
    <?php endif; ?>
                 ...
                 <!-- ============================================================================ -->
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.program')); ?> </b></h6>
                    <?php
...
<h6 class="col-md-9">
    <?php if(app()->getLocale() == 'zh'): ?>
        <?php echo e($program_map[$user->program->program_name_en] ?? $user->program->program_name_en); ?>

    <?php else: ?>
        <?php echo e($user->program->{'program_name_'.app()->getLocale()}); ?>
    ...
    <?php endif; ?>
                ...
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.education_history')); ?></b></h6>
...
<h6 class="col-md-4" style="line-height:1.4;">
    <?php $__currentLoopData = $user->education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo e($edu_qua_map[$edu->qua_name] ?? $edu->qua_name); ?><br>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</h6>
...
<h6 class="col-md-5" style="line-height:1.4;">
    <?php $__currentLoopData = $user->education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo e($uni_map[$edu->uname] ?? $edu->uname); ?><br>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</h6>
                </div>
                <?php endif; ?>
                <div class="row mt-2">
                    <h6 class="col-md-3"><b><?php echo e(trans('message.password')); ?> :</b></h6>
                    <h6 class="col-md-9"></h6>
                </div>
                <div class="row mt-2">
                    <h6 class="col-md-3"><b>Scholar ID :</b></h6>
                    <h6 class="col-md-9"><?php echo e($user->scholar_id ?? '-'); ?></h6>
                </div>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-create')): ?>
                <a class="btn btn-primary btn-sm mt-5" href="<?php echo e(route('users.index')); ?>"><?php echo e(trans('message.back')); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Work2568\ProjectSoften\git-group-repository-group-2-sec-2\cpresearchV2\code\resources\views/users/show.blade.php ENDPATH**/ ?>