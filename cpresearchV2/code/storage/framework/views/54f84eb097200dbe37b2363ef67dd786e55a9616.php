...
<head>
    ...
    <title><?php echo e(trans('message.title_web')); ?></title>
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand logo-image" href="#">
                <?php if(App::getLocale() == 'zh'): ?> 
                    <img src="<?php echo e(asset('img/logo3_ZH.png')); ?>" alt="Logo for Chinese">
                <?php elseif(App::getLocale() == 'th'): ?> 
                    <img src="<?php echo e(asset('img/logo1_TH.png')); ?>" alt="Logo for Thai">
                <?php else: ?> 
                    <img src="<?php echo e(asset('img/logo2_EN.png')); ?>" alt="Logo for English or Default">
                <?php endif; ?>
            </a>
            <!--P'France_Edit-->
                ...
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <lifp
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('researchers',['id'=>$role->id])); ?>">
                                    <?php echo e(trans($roleKey)); ?>
...
<?php /**PATH C:\Users\User\Desktop\Work2568\ProjectSoften\git-group-repository-group-2-sec-2\cpresearchV2\code\resources\views/layouts/layout.blade.php ENDPATH**/ ?>