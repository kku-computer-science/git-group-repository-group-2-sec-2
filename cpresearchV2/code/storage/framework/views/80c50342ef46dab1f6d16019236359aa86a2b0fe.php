            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"><?php echo e(trans('message.header')); ?><span
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <form class="search-form" action="#">
                            ...
                            <input type="search" class="form-control" placeholder="<?php echo e(trans('message.search')); ?>" title="Search here">
                        </form>
                    </li>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('admin/profile*')) ? 'active' : ''); ?>"
                            ...
                            <span class="menu-title"><?php echo e(trans('message.profile')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('researchProjects.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.project')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('researchGroups.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.group')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manage_publication')); ?></span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('papers.index')); ?>"><?php echo e(trans('message.research')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/books"><?php echo e(trans('message.book')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/patents"><?php echo e(trans('message.patent')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('programs.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manage_program')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('experts.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.expertise_menu')); ?></span>

                        </a>
                    </li>
                    <?php endif; ?>
                    
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('apistatus-list')): ?>
                    <li class="nav-item nav-category"><?php echo e(trans('message.api_status')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('apistatus.index')); ?>">
                            <i class="menu-icon mdi mdi-server"></i>
                            <span class="menu-title"><?php echo e(trans('message.research_API')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('certificate-form')): ?>
                    <li class="nav-item nav-category"><?php echo e(trans('message.for_student')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('certificate_form.index')); ?>">
                            <i class="menu-icon mdi mdi-school"></i> 
                            <span class="menu-title"><?php echo e(trans('message.certificate_form')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('highlight')): ?>
                    <li class="nav-item nav-category"><?php echo e(trans('message.for_staff')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('highlight.index')); ?>">
                            <i class="menu-icon mdi mdi-star"></i> 
                            <span class="menu-title"><?php echo e(trans('message.highlight')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assistant-researcher')): ?>
                    <li class="nav-item nav-category"><?php echo e(trans('message.for_head')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('assistant_researcher.index')); ?>">
                            <i class="menu-icon mdi mdi-account-tie"></i> 
                            <span class="menu-title"><?php echo e(trans('message.assistant_wanted')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\User\Desktop\Work2568\ProjectSoften\git-group-repository-group-2-sec-2\cpresearchV2\code\resources\views/dashboards/users/layouts/user-dash-layout.blade.php ENDPATH**/ ?>