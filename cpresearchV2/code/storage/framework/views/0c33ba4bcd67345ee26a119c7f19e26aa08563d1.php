...
<body>
    ...
    <label for="username"><?php echo e(trans('message.username')); ?></label>
    <input id="username" 
           type="text" 
...
unset($__errorArgs, $__bag); ?>" 
           ...
           required 
           autofocus 
           data-error-message="<?php echo e(trans('validation.required_field')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
					...
					<div class="form-group">
						<label class="form-remember">
							<input id="ckb1" name="remember" type="checkbox" /><?php echo e(trans('message.remember_me')); ?>
					...
					<ul>
						<li><?php echo e(trans('message.username_login')); ?></li>
						<li><?php echo e(trans('message.username_student')); ?></li>
					</ul>
				</form>
			</div>
		</div>
...
</html><?php /**PATH C:\Users\User\Desktop\Work2568\ProjectSoften\git-group-repository-group-2-sec-2\cpresearchV2\code\resources\views/auth/login.blade.php ENDPATH**/ ?>