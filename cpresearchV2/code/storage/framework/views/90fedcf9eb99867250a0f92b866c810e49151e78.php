...
<div class="container home">
            ...
            <div class="carousel-inner">
                <?php if(App::getLocale() == 'zh'): ?>  
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('img/Banner1_zh.png')); ?>" class="d-block w-100" alt="Banner in Chinese">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('img/Banner2_zh.png')); ?>" class="d-block w-100" alt="Banner in Chinese">
                    </div>
                <?php elseif(App::getLocale() == 'en'): ?>  
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('img/Banner1_en.png')); ?>" class="d-block w-100" alt="Banner in English">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('img/Banner2_en.png')); ?>" class="d-block w-100" alt="Banner in English">
                    </div>
                <?php else: ?> 
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('img/Banner1.png')); ?>" class="d-block w-100" alt="Banner in Default Language">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('img/Banner2.png')); ?>" class="d-block w-100" alt="Banner in Default Language">
                    </div>
                <?php endif; ?>
                <!-- <div class="carousel-item">
    ...
    <div class="modal" id="myModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(trans('message.referenceapa')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(trans('message.close')); ?>"></button>
                </div>
                <div class="modal-body" id="name">
                    <!-- เนื้อหาอ้างอิง -->
                </div>
    ...
    var barChartOptions = {
        ...
        scales: {
            yAxes: [{
                scaleLabel: {
                    display: true,
                    labelString: <?php echo json_encode(__('message.number'), 15, 512) ?>
                }
            }],
            xAxes: [{
                scaleLabel: {
                    display: true,
                    labelString: <?php echo json_encode(__('message.year'), 15, 512) ?>
                }
            }]
        },
        ...
        title: {
            display: true,
            text: <?php echo json_encode(__('message.report_total_articles'), 15, 512) ?>,
            fontSize: 20
        }
        /*P'France_new*/
    ...
    (function($) {
        ...
        */
        document.getElementById("all").innerHTML += `
                <i class="count-icon fa fa-book fa-2x"></i>
                <h2 class="timer count-title count-number" data-to="${sum}" data-speed="1500"></h2>
                <p class="count-text ">${<?php echo json_encode(__('message.SUMMARY'), 15, 512) ?>}</p>`
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Work2568\ProjectSoften\git-group-repository-group-2-sec-2\cpresearchV2\code\resources\views/home.blade.php ENDPATH**/ ?>