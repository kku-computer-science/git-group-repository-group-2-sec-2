                ...
                <div class="card-body">
                    ...
                    <h6 class="card-text"><b><?php echo e($res->fname_en); ?> <?php echo e($res->lname_en); ?>, <?php echo e($res->doctoral_degree); ?> </b>
                        ...
                        <h6 class="card-text"><b><?php echo e($res->fname_en); ?> <?php echo e($res->lname_en); ?></b>
                            <?php endif; ?></h6>
                            <h6 class="card-text1"><b><?php echo e($res->{'academic_ranks_' . app()->getLocale()}); ?></b></h6>
                    ...
                    <h6 class="card-text1">Khon Kaen University</h6> -->
                        <h6 class="card-text1"><?php echo e(trans('message.Email')); ?>: <?php echo e($res->email); ?></h6>
...
?>
                        ...
                        <h6 class="card-text2 col-sm-10"> <?php echo e($edu->year); ?> <?php echo e($edu_qua_map[$edu->qua_name] ?? $edu->qua_name); ?> <?php echo e($uni_map[$edu->uname] ?? $edu->uname); ?></h6>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="patent-tab" data-bs-toggle="tab" data-bs-target="#patent" type="button" role="tab" aria-controls="patent" aria-selected="false"><?php echo e(trans('message.Others')); ?></button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="tab-content" style="padding-bottom: 20px;">
                <a class="btn btn-success" href="<?php echo e(route('excel', ['id' => $res->id])); ?>" target="_blank"><?php echo e(trans('message.Export to Excel')); ?></a>
            </div>
            <table id="example1" class="table table-striped" style="width:100%">
                <thead>
                    ...
                    <tr>
                        ...
                        <th><?php echo e(trans('message.Paper Name')); ?></th>
                        <th><?php echo e(trans('message.Author')); ?></th>
                        <th><?php echo e(trans('message.Document Type')); ?></th>
    ...
    ?>
    <?php echo e($fname); ?> <?php echo e($lname); ?></teacher>
                                </a>
                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </td>
            ...
            <table id="example2" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th><?php echo e(trans('message.No.')); ?></th>
                        <th><?php echo e(trans('message.Year')); ?></th>
                        <th style="width:90%"><?php echo e(trans('message.Paper Name')); ?></th>
                        <th><?php echo e(trans('message.Author')); ?></th>
                        <th><?php echo e(trans('message.Document Type')); ?></th>
    ...
    ?>
    <?php echo e($fname); ?> <?php echo e($lname); ?></teacher></a>
                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </td>
                        <td><?php
    ...
    <?php echo e($fname); ?> <?php echo e($lname); ?></teacher></a>
        ...
        <div class="tab-pane fade" id="book" role="tabpanel" aria-labelledby="book-tab">
            <table id="example5" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th scope="col"><?php echo e(trans('message.No.')); ?></th>
                        <th scope="col"><?php echo e(trans('message.Year')); ?></th>
                        <th scope="col"><?php echo e(trans('message.BookName')); ?></th>
                        <th scope="col"><?php echo e(trans('message.Author')); ?></th>
                        <th scope="col"><?php echo e(trans('message.Publication Place')); ?></th>
            ...
            <table id="example6" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><?php echo e(trans('message.Registration Number')); ?></th>
                        <th scope="col"><?php echo e(trans('message.Registration Date')); ?></th>
    ...
    <table id="example7" class="table table-striped" style="width:100%">
        ...
        <tbody>
            <?php $__currentLoopData = $papers_scholar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n => $paper): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td> <?php echo e($n+1); ?></td>
                <td><?php echo e($paper->paper_yearpub); ?></td>
                <td style="width:90%;"><?php echo html_entity_decode(preg_replace('<inf>', 'sub', $paper->paper_name)); ?></td>
    ...
    <?php echo e($fname); ?> <?php echo e($lname); ?></teacher></a>
                ...
                <td><?php echo e($paper->paper_page); ?></td>
                <td><?php echo e($paper->paper_sourcetitle); ?></td>
                <td><?php echo e($paper->paper_citation); ?></td>
                <td><?php echo e($paper->paper_doi); ?></td>
            </tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\Work2568\ProjectSoften\git-group-repository-group-2-sec-2\cpresearchV2\code\resources\views/researchprofiles.blade.php ENDPATH**/ ?>